...
# 修改输入图片文件夹
img_folder = r"/nfsv4/23039356r/data/yolo_fomat_c5/images/train"
img_list = os.listdir(img_folder)
img_list.sort()

# 修改输入标签文件夹
label_folder = r"/nfsv4/23039356r/data/yolo_fomat_c5/labels/train"
label_list = os.listdir(label_folder)
label_list.sort()

# 输出图片文件夹位置
path = os.getcwd()
output_folder = r"/nfsv4/23039356r/data/yolo_fomat_c5\images\train_vis"
if not os.path.exists(output_folder):
    os.mkdir(output_folder)

colormap = [(0, 255, 0),(255, 0, 0),(0, 0, 255), (132, 112, 255), (0, 191, 255)]  # 色盘，可根据类别添加新颜色
...
if __name__ == '__main__':
    ...
    img_folder = r"/nfsv4/23039356r/data/yolo_fomat_c5/images/val"
    img_list = os.listdir(img_folder)
    for i in tqdm(range(len(img_list))):
        image_path = os.path.join(img_folder, img_list[i])
        label_path = os.path.join(label_folder, label_list[i])
